...
ALTER TABLE alert_x_type_cycle
  ...
  ADD CONSTRAINT alert_type_fk FOREIGN KEY (type_x_cycle_id)
    REFERENCES type_x_cycle (type_x_cycle_id) ON DELETE CASCADE ON UPDATE CASCADE;

DROP TABLE IF EXISTS notification CASCADE;
CREATE TABLE notification (
  alert_id INTEGER REFERENCES alert(alert_id) NOT NULL,
  url_id INT REFERENCES url(url_id) NOT NULL,
  type_x_cycle_id INTEGER REFERENCES type_x_cycle(type_x_cycle_id) NOT NULL,
  ...
  spider_uuid UUID REFERENCES spider(spider_uuid) NOT NULL,
