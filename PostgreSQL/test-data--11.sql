...
VALUES
    ...
    ('markus.wanner@datahouse.ch',
     '5aa5a330c478658204d4753b02484cf3c2d9be3d703dc36e8d21ad8ff784d003',
     'e[(?3oMm+Xc|YHMF', NOW()),
    ('flavio.neuenschwander@datahouse.ch',
     '5aa5a330c478658204d4753b02484cf3c2d9be3d703dc36e8d21ad8ff784d003',
     'e[(?3oMm+Xc|YHMF', NOW());
...
INSERT INTO url (url_title, url, url_creator_user_id, check_frequency_id,
                 xfrm_id, url_group_id)
VALUES
    ('Datahouse Website', 'http://www.datahouse.ch/technologie', 1, 1, 1, 1),
    ('Wüest & Partner', 'http://www.wuestundpartner.com/en/online-services/overview.html', 1, 1, 1, 1),
    ('Tagesanzeiger Online', 'http://www.tagesanzeiger.ch', 1, 2, 1, 1),
    ('IFES Evaluationen', 'http://www.ifes-ipes.ch/de/ueber-das-ifes/', 1, 2, 1, 1),
    ('Abacus Produkte', 'http://www.abacus.ch/produkte/abacus-vi/produktportrait/', 1, 3, 1, 1),
    ('Datahouse Mitarbeiter', 'http://www.datahouse.ch/team', 1, 3, 1, 1),
    ('PHP Storm News', 'https://www.jetbrains.com/phpstorm/whatsnew/', 1, 2, 1, 1),
    ('Kinoprogramm Zürich', 'http://www.cineman.ch/kinoprogramm/Zürich/', 1, 2, 1, 1),
    ('ZKB Finanzinformationen', 'https://zkb-finance.mdgms.com/home/index.html', 1, 2, 1, 1),
    ('Meet Jenkins', 'https://wiki.jenkins-ci.org/display/JENKINS/Meet+Jenkins', 1, 2, 1, 1),
    ('PHP Release', 'http://php.net/', 1, 2, 1, 1),
    ('ESRI Schweiz', 'http://www.esri.ch/schulung/kursangebot', 1, 2, 1, 1),
    ('Geopost Daten', 'https://www.post.ch/post-startseite/post-adress-services-match/post-gis/post-gis-geoportal.htm', 1, 2, 1, 1);
