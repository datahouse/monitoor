...
CREATE TABLE IF NOT EXISTS account (
  ...
  user_id INTEGER NOT NULL,
  account_name_first varchar(255) NULL,
  account_name_last varchar(255) NULL,
  account_mobile varchar(20) NULL,
  account_company varchar(255) NULL,
...
CREATE TABLE IF NOT EXISTS url_group (
  ...
  is_widget boolean NOT NULL DEFAULT false,
...
-- Used for the status page, aggregating data for 1/144th of a day for
-- the last 24 hours, i.e. in 10 minute buckets. Mainly used for the
-- status page.  Query with a predicate on spider_uuid for reasonable
-- performance.
