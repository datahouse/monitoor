...
CREATE FUNCTION spider_store_document(in_job_id INT, in_old_doc_id INT, in_spider_uuid UUID,
                                      in_contents BYTEA, alert_ids INT[])
RETURNS BIGINT
AS $$
DECLARE
  inserted_doc_id INT;
BEGIN
  INSERT INTO spider_document (job_id, contents)
    VALUES (in_job_id, in_contents)
  ...
  SELECT i.alert_id, i.url_id, i.type_x_cycle_id,
         old_doc.max_doc_id, inserted_doc_id, in_spider_uuid
