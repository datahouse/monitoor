CREATE FUNCTION test_url_simple_insert()
RETURNS SETOF TEXT
AS $$
DECLARE
  test_user_id INT;
...
CREATE FUNCTION test_url_insert_deactivate()
RETURNS SETOF TEXT
AS $$
DECLARE
  test_user_id INT;
...
CREATE FUNCTION test_url_delete_reactivate()
RETURNS SETOF TEXT
AS $$
DECLARE
  test_user_id INT;
...
CREATE FUNCTION test_url_insert_twice_lower_freq()
RETURNS SETOF TEXT
AS $$
DECLARE
  test_user_id INT;
...
CREATE FUNCTION test_url_insert_twice_then_update_freq()
RETURNS SETOF TEXT
AS $$
DECLARE
  test_user_id INT;
...
CREATE FUNCTION test_url_insert_twice_higher_freq()
RETURNS SETOF TEXT
AS $$
DECLARE
  test_user_id INT;
...
CREATE FUNCTION test_url_insert_update_url()
RETURNS SETOF TEXT
AS $$
DECLARE
  test_user_id INT;
...
CREATE FUNCTION test_url_insert_update_freq()
RETURNS SETOF TEXT
AS $$
DECLARE
  test_user_id INT;
...
CREATE FUNCTION test_url_insert_twice_then_deactivate_other()
RETURNS SETOF TEXT
AS $$
DECLARE
  test_user_id INT;
...
CREATE FUNCTION test_url_insert_twice_then_deactivate_both()
RETURNS SETOF TEXT
AS $$
DECLARE
  test_user_id INT;
